...
Nagu ka cp, kui sa liigutad faili või kataloogi, siis see kirjutab üle, kui seal kataloogis juba midagi samanimelist on. Seega, kasuta -i lippu, et saaksid teate enne kui midagi üle kirjutatakse.

<pre>$ mv -i kataloog1 kataloog2</pre>

Aga ütleme, et sa tahad liigutada faili nõnda, et see kirjutaks eelmise üle. Sa võid teha failist varuvariandi, sel juhul nimetatakse vana fail ümber ~ sümboliga.
